...
import 'package:moyo/widgets/sized_icon_button.dart';
  ...
  Future<void> connectToSpotifyRemote() async {
    try {
      ...
      var result = await SpotifySdk.connectToSpotifyRemote(
          clientId: dotenv.env['28e25b413e3645598c775497a6940f0d'].toString(),
          redirectUrl: dotenv.env['http://localhost:3000'].toString());
      setStatus(result
